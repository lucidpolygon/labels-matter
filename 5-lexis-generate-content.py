...
AIRTABLE_LEXIS_TABLE = os.getenv("AIRTABLE_LEXIS_TABLE", "tblH13TjGgaxQ57Tl")
...
AIRTABLE_ATTACHMENT_FIELD = "Complaint File"
...
F_CONTENT_LEXIS_LINK = "Lexis Case"
...
if not AIRTABLE_BASE_ID or not AIRTABLE_LEXIS_TABLE:
    raise RuntimeError("Missing AIRTABLE_BASE_ID / AIRTABLE_LEXIS_TABLE")
    
# ----------------------------
# Airtable table URLs
# ----------------------------
AIRTABLE_URL = f"https://api.airtable.com/v0/{AIRTABLE_BASE_ID}/{AIRTABLE_LEXIS_TABLE}"
...
def process_record(rec: Dict, prompt_tpl: dict) -> None:
    ...
    fields_to_create = {
        ...
        F_CONTENT_LEXIS_LINK: [record_id],
    ...
    if AIRTABLE_STATUS_FIELD:
        airtable_update_record(record_id, {AIRTABLE_STATUS_FIELD: "Yes"})
...
def main():
    ...
    prompt_tpl = fetch_prompt_by_title("lexis_article_create")
